...
export const DEMO_MIN_SPEECH_DURATION_MS = 320
export const DEMO_VAD_ACTIVATION_THRESHOLD = 0.75
export const DEMO_UI_VAD_PROBABILITY_THRESHOLD = 0.75
...
export const DEMO_MIN_SILENCE_DURATION_MS = 800
